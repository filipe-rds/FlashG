...
public interface CommentRepository extends JpaRepository<Comment, Long> {
    ...
    @Query("SELECT c FROM Comment c WHERE c.photo.id = :photoId ORDER BY c.createdAt ASC")
    List<CommentProjection> findCommentTextAndCreatedAtByPhotoIdOrderByCreatedAtAsc(@Param("photoId") Long photoId);
